...
export const cardsAPI = {
    ...
    sendMail(email: string) {
        return instance.post(`auth/forgot`, {
            ...
            <a style="text-decoration: none; color: white; background-color: #21268F; outline: none; border: none; padding: 15px 20px;border-radius: 7px"http://localhost:3000/#/set-new-password/$token$'>Reset password</a>
        </div>`
        })
    },
